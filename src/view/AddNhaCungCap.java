...
//        }
        try {
            ...
            if (maNcc.equals("") || tenNcc.equals("") || sdtNcc.equals("") || diachiNcc.equals("")) {
                ...
                NhaCungCap existingNcc = NhaCungCapDAO.getInstance().selectById(maNcc);
                if (existingNcc == null) {
                    // Mã nhà cung cấp chưa tồn tại, có thể thêm mới
                    NhaCungCap ncc = new NhaCungCap();
                    ncc.setMaNhaCungCap(maNcc);
                    ncc.setTenNhaCungCap(tenNcc);
                    ncc.setSdt(sdtNcc);
                    ...
                    // Mã nhà cung cấp đã tồn tại, hiển thị cảnh báo
                    JOptionPane.showMessageDialog(this, "Mã nhà cung cấp đã tồn tại!", "Cảnh báo!", JOptionPane.WARNING_MESSAGE);
                }
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Thêm không thành công: " + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
