...
//        pf.checkRole(currentAcc);
    ...
    private void initComponents() {
        ...
        NavbarMenu.add(NameUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 160, -1));

        jLabel8.setFont(new java.awt.Font("SF Pro Display", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("HI !");
        NavbarMenu.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 40, -1));
        ...
        time.setFont(new java.awt.Font("Stencil Std", 1, 24)); // NOI18N
        time.setForeground(new java.awt.Color(255, 255, 0));
        time.setText("TIME");
        NavbarMenu.add(time, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 130, 50));
